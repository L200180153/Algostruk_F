...
c0 = MhsTIF('Anita', "L200180153", 'Sragen', 150000)
c1 = MhsTIF('Vintan', "L200180144", 'Sukoharjo', 125000)
c2 = MhsTIF('Aulia', "L200180156", 'Solo', 20500)
c3 = MhsTIF('Rohana', "L200180132", 'Klaten', 350000)
c4 = MhsTIF('Kenygi', "L200180300", 'Wonogiri', 500000)
c5 = MhsTIF('Anggit', "L200180111", 'Nusa Tenggara', 430000)
c6 = MhsTIF('Saidah', "L200180301", 'Batang', 450000)
c7 = MhsTIF('Siwi', "L200180302", 'Tegal', 430000)
c8 = MhsTIF('Aul', "L200180303", 'Mojokerto', 235000)
c9 = MhsTIF('Ami', "L200180088", 'Sragen', 350000)
